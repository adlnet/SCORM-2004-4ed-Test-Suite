        ...
        <xsl:if test='@type="info"'>
            ...
            <xsl:if test="not($conf)">
                <tr>
                    ...
                    <td>
                        <span style="color:#566B87;font-family:Verdana;font-weight:bold;font-size:12px">
                            <xsl:value-of select="."/>
                        </span>
                    </td>
                </tr>
        ...
        <tr>
            ...
            <td>
                <a>
                    ...
                    <xsl:if test='@type="MD"'>
                        <span style="font-family:Verdana;font-weight:bold;font-size:12px">
                            Click here to view detailed MD test log
                    ...
                    <xsl:if test='@type="SCO"'>
                        <span style="font-family:Verdana;font-weight:bold;font-size:12px">
                            Click here to view detailed SCO test log
                            <xsl:value-of select="@name"/>
                        </span>
                    </xsl:if>
                    ...
                    <xsl:if test='@type="LMS"'>
                        <span style="font-family:Verdana;font-weight:bold;font-size:12px">
                            Click here to view detailed log for Test Package 
                            <xsl:value-of select="@name"/>
                        </span>
                    </xsl:if>
                </a>
