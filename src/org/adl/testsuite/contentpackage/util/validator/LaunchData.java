...
public class LaunchData
{
   ...
   /**
    * The variable representing the adl data stores found in the sequencing. 
    */
   ...
   public LaunchData()
   {
      ...
      mDataMapDataList              = new ArrayList();
      mPrevious                     = false;
      mContinue                     = false;
      mExit                         = false;
      mExitAll                      = false;
   ...
   public String getLaunchLine()
   {
      ...
      if ( !parameterString.equals("") )
      {
         ...
         if ( parameterString.startsWith("#") )
         {
            ...
            {
               return handler.decode(xmlBase + launchLine, "UTF-16");
            }
            // if the above return is not executed return the following
            return handler.decode(xmlBase + launchLine, "UTF-16") + parameterString;
   ...
   /**
    * Gets the data map data list
    * 
    * @return Returns the mDataMapDataList.
    */
   public List getDataMapDataList()
   {
      return mDataMapDataList;
   }

   /**
    * Sets the data map data list
    * 
    * @param iDataMapDataList The mDataMapDataList to set.
    */
   public void setDataMapDataList(List iDataMapDataList)
   {
      mDataMapDataList = iDataMapDataList;
   }
}